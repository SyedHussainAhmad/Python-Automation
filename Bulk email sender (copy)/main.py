...
def main():
    ...
    EMAIL_SUBJECT = 'Welcome to ePresence Builders - Lead Generation Specialist Position'

    with open('D:\F Drive\Work\Programming\Python\Coding\Projects\Advanced Projects\Bulk email sender (copy)\content.txt') as f:
        EMAIL_CONTENT = f.read()

    csv_file_path = 'D:\F Drive\Work\Programming\Python\Coding\Projects\Advanced Projects\Bulk email sender (copy)\data.csv'
